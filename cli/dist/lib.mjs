...
var ExtractorStrategySchema = external_exports.enum(["auto", "network", "legacy"]).default("auto");
var ConfigSchema = external_exports.object({
  styling: external_exports.object({
    tailwind: external_exports.union([external_exports.literal(3), external_exports.literal(4)]),
    themeFile: external_exports.string().optional(),
    config: external_exports.string().optional()
  }).optional(),
  componentsDir: external_exports.string().default("components"),
  previewDir: external_exports.string().default("app"),
  devCommand: external_exports.string().default("npm run dev"),
  devPort: external_exports.number().optional(),
  fonts: external_exports.array(external_exports.string()).default([]),
  reportDir: external_exports.string().default("docs/d2c"),
  writeAllowlist: external_exports.array(external_exports.string()).default([]),
...
async function uygulamaTeyit(page, beklenenTestid) {
...
export {
  ...
  OlcuSchema,
  ElemanSchema2 as OlcumElemanSchema,
  FontSchema2 as OlcumFontSchema,
  KonturSchema2 as OlcumKonturSchema,
  OlcumSchema,
  PARITE_ESIGI,
  ROBUST_SCHEMA_VERSION,
  BulguSchema as RobustBulguSchema,
  RobustSchema,
  SCHEMA_VERSION,
